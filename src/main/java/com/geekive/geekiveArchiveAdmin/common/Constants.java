package com.geekive.geekiveArchiveAdmin.common;
...
public class Constants {
	...
	/* pagination */
	public static int dataCountPerPage 			= 10;	// the number of data in one page
	...
	/* banned archive name */
	public static final String[] BANNED_ARCHIVE_NAME = {"css", "js", "upload", "menu", "error", "sign", "email", "admin", "storage"};
}
